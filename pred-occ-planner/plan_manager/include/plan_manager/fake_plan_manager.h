...
#include <vector>
// #include "traj_server/bezier_traj_server.hpp"
...
class FiniteStateMachineFake {
 ...
 private:
  ...
  ros::Publisher  _traj_pub, _broadcast_traj_pub, one_plan_time_pub;

  ros::Time _traj_start_time;
  ros::Time _prev_plan_time;
  ros::Time _one_plan_time;
  ...
  // BezierTrajServer bezier_traj_server;
};
