...
void MADER::init() {
  ...
  nh_.param("swarm/drone_size_x", drone_size_x_, 0.6);
  nh_.param("swarm/drone_size_y", drone_size_y_, 0.6);
  nh_.param("swarm/drone_size_z", drone_size_z_, 0.1);  // avoid z-axis wind effect
